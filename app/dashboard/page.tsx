  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white flex items-center justify-between px-8 py-4 border-b border-gray-100">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 bg-purple-50 px-3 py-1.5 rounded-lg">
            <span className="text-xs text-purple-600 font-medium">5 credits</span>
          </div>
      ...
      <div className="px-8 py-8 max-w-6xl mx-auto">
        ...
        {/* Welcome */}
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-900">Welcome back, Raj 👋</h1>
          <p className="text-gray-500 text-sm mt-1">Here is what is happening with your campaigns.</p>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-xl p-5 border border-gray-100">
            ...
            <div className="text-2xl font-semibold text-purple-600">5</div>
            <div className="text-xs text-gray-400 mt-1">Free welcome credits</div>
          </div>
          <div className="bg-white rounded-xl p-5 border border-gray-100">
        ...
        <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-100 hover:bg-gray-50">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">Browse influencers</div>
                  <div className="text-xs text-gray-400">Search by niche, platform, and location — free</div>
                </div>
                <a href="/discover" className="text-xs text-purple-600 font-medium">Browse →</a>
              </div>
              <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-100 hover:bg-gray-50">
                <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center text-lg">⚡</div>
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">Get an AI report</div>
                  <div className="text-xs text-gray-400">Deep analysis of any influencer — 3 credits</div>
                </div>
                <a href="/discover" className="text-xs text-purple-600 font-medium">Try it →</a>
              </div>
              <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-100 hover:bg-gray-50">
                <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center text-lg">📩</div>
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">Send a campaign proposal</div>
                  <div className="text-xs text-gray-400">Contact an influencer directly — 10 credits</div>
                </div>
                <a href="/discover" className="text-xs text-purple-600 font-medium">Start →</a>
              </div>
              <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-100 hover:bg-gray-50">
                <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center text-lg">💳</div>
                <div className="flex-1">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6">
            ...
            <div className="text-center py-4">
              <div className="text-5xl font-semibold text-purple-600 mb-1">5</div>
            ...
            <div className="border-t border-gray-100 pt-4 mt-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-xs">
                  ...
                  <span className="text-gray-900 font-medium">0x</span>
                </div>
              </div>
            </div>
          </div>
