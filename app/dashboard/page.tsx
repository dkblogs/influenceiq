  ...
  return (
    <main className="min-h-screen bg-[#0A0A0F]">
      ...
      <div className="px-4 md:px-8 py-6 md:py-8 max-w-6xl mx-auto">
        ...
        {/* Portfolio moved to /profile */}
        {user.role === "influencer" && (
          <div className="mt-6 bg-[#12121A] rounded-2xl border border-[#1E1E2E] p-5 flex items-center justify-between">
            <div>
              <div className="text-sm font-medium text-[#F8FAFC]">My Portfolio</div>
              <div className="text-xs text-[#64748B] mt-0.5">Manage your collaborations on your profile page</div>
            </div>
            <a href="/profile" className="text-xs bg-purple-600/20 border border-purple-500/30 text-purple-300 px-3 py-1.5 rounded-lg hover:bg-purple-600/30 transition-colors whitespace-nowrap">
              Go to Profile →
            </a>
          </div>
        )}
